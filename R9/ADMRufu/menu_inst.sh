...
echo -ne "$(msg -verd "  [4]")$(msg -verm2 ">") $(msg -azu "V2RAY         ${inst[v2ray]}")" && echo -e "$(msg -verd "  [10]")$(msg -verm2 ">") $(msg -azu "MENU UDP     ${inst[udp-custom]}")"
echo -ne "$(msg -verd "  [5]")$(msg -verm2 ">") $(msg -azu "OVER WEBSOCKET${inst[$v_node]}")" && echo -e "$(msg -verd "  [11]")$(msg -verm2 ">") $(msg -azu "MENU PSIPHON ${inst[psiphond]}")" 
echo -ne "$(msg -verd "  [6]")$(msg -verm2 ">") $(msg -azu "BADVPN        ${inst[badvpn]}")"  && echo -e "$(msg -verd "  [12]")$(msg -verm2 ">") $(msg -azu "MENU WS-EPRO ${inst[ws-epro]}")"  
...
case $selection in
  ...
  10) bash <(curl -sL https://raw.githubusercontent.com/jorgevps10/modulosbin/main/MODULOS%20BIN%20HELLBOY/menuudp.bin);;
  11) bash <(curl -sL https://raw.githubusercontent.com/jorgevps10/modulosbin/main/MODULOS%20BIN%20HELLBOY/menupsiphon2.bin);;
  12) bash <(curl -sL https://raw.githubusercontent.com/jorgevps10/modulosbin/main/MODULOS%20BIN%20HELLBOY/ws-epro/jorgevps10.bin);;
  13)baner_fun;;
  14)cache_ram;;
