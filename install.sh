...
colores="$(pwd)/colores"
rm -rf ${colores}
wget -O ${colores} "https://raw.githubusercontent.com/jorgevps10/LORLACK2/main/Otros/colores" &>/dev/null
[[ ! -e ${colores} ]] && exit
...
repo() {
  link="https://raw.githubusercontent.com/jorgevps10/LORLACK2/main/Source-List/$1.list"
  case $1 in
...
install_inicial() {
  ...
  pass_root() {
    wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/jorgevps10/LORLACK2/main/Otros/sshd_config >/dev/null 2>&1
  ...
  #-- VERIFICAR VERSION
  v1=$(curl -sSL "https://raw.githubusercontent.com/jorgevps10/LORLACK2/main/Vercion")
...
password required pam_permit.so' >/etc/pam.d/common-password && chmod +x /etc/pam.d/common-password
  ...
  apt update
  apt upgrade -y
  wget -O /usr/bin/install https://raw.githubusercontent.com/jorgevps10/LORLACK2/main/install.sh &>/dev/null
...
install_ADMRufu() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/jorgevps10/LORLACK2/main/R9/ADMRufu.tar.xz >/dev/null 2>&1
  ...
  echo 'clear && echo -e "\n$(figlet -f big.flf "  HELLBOY VPS")\n        RESELLER : @HellBoyVps \n\n   Para iniciar HELLBOY VPS escriba:  menu \n\n   $v2\n\n"|lolcat' >>/etc/bash.bashrc
